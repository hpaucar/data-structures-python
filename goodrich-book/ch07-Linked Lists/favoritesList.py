class FavoritesList:
    ...
    def access(self, e):
        ...
        if p is None:
            p = self._find_position(self._Item(e))  #if new, place at end
...
class FavoritesListMTF(FavoritesList):
    """Listt of elements ordered with move-to-front heuristic."""
    ...
    def top(self, k):
        ...
        for j in range(k):
            ...
            yield highPos.element()._value      # report item to user
